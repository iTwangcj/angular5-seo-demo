import { Component, ElementRef, EventEmitter, forwardRef, Inject, Input, OnInit, Output, PLATFORM_ID, Renderer2 } from '@angular/core';
...
export class PaginationComponent implements ControlValueAccessor, OnInit {
    ...
    constructor (renderer: Renderer2,
                 elementRef: ElementRef,
                 paginationConfig: PaginationConfig, @Inject(PLATFORM_ID) private platformId) {
